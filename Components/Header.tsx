  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Welcome to BlogITUP, a platform where your thoughts turn into stories.
Write blogs, discover content from others, and connect through words. Whether you are a beginner or a seasoned writer, our minimal and distraction-free interface helps you focus on what truly matters — your voice.</p>
